...
export class Contract extends Web3Context {
    ...
    deploy(deployOptions) {
        ...
        const _input = format({ format: 'bytes' }, (_b = (_a = deployOptions === null || deployOptions === void 0 ? void 0 : deployOptions.input) !== null && _a !== void 0 ? _a : deployOptions === null || deployOptions === void 0 ? void 0 : deployOptions.data) !== null && _b !== void 0 ? _b : this.options.input, DEFAULT_RETURN_FORMAT);
        ...
        return {
            ...
            encodeABI: () => encodeMethodABI(abi, args, format({ format: 'bytes' }, _input, DEFAULT_RETURN_FORMAT)),
        };
    }
